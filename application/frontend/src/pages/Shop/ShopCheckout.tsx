...
const ShopCheckout: React.FC = () => {
  ...
  const handleCheckout = async () => {
    await fetch(`http://ec2-54-221-146-123.compute-1.amazonaws.com:3333/users/${userClaims.id}/checkout`, {
      method: "PUT",
    })
      .then(() => {
        fetchCartItems();
  ...
  const handleRemoveItem = async (itemId: string) => {
    await fetch(`http://ec2-54-221-146-123.compute-1.amazonaws.com:3333/users/${userClaims.id}/cart`, {
      method: "DELETE",
      body: itemId,
    })
      .then(() => {
